...
- Use strftime('%Y', 'now') only as a fallback — prefer 2026 for "this year".
...
- Karnataka is a state, not a city. Map state names to their cities: Karnataka → Bengaluru, Mysuru, Coimbatore. Use IN clause for multiple cities. Figure out state if not explicity mentioned here
...
- Format all numbers using the Indian numbering system with commas:
  1,00,000 (1 lakh), 10,00,000 (10 lakh), 1,00,00,000 (1 crore).
  Never use Western formatting like 1,000,000.
  Express large amounts as: ₹1.25 crore, ₹45.6 lakh — not raw numbers.
